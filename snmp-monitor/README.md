...
-  **Risultato:** L'analisi di `metrics.csv` mostra due polling distanziati di circa 30 secondi seguiti da un terzo polling a circa 1 secondo dal precedente, eseguito immediatamente dopo l'invio della trap.
